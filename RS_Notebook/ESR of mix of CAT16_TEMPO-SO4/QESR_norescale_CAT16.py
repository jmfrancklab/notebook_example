            ...
            [
              ...
              #      None),
               ('230726_CAT16_W0.DSC', exp_type, '(A) W0=0', 'red', 0.2, 200, '230202', 'QESR caps',
                    None),
               ('230726_CAT16_W2.DSC', exp_type, '(B) W0=2', 'orange', 0.2, 200, '230202', 'QESR caps',
                    None),
               ('230726_CAT16_W10.DSC', exp_type, '(C) W0=10', 'yellow', 0.2, 200, '230202', 'QESR caps',
                    None),
               ('230726_CAT16_W25.DSC', exp_type, '(D) W0=25', 'green', 0.2, 200, '230202', 'QESR caps',
                    None), 
               ('230726_CAT16_W50.DSC', exp_type, '(E) W0=50', 'blue', 0.2, 200, '230202', 'QESR caps',
                    None)
