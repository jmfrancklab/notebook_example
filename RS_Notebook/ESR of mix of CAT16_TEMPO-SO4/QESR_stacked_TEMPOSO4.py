...
with figlist_var() as fl:
    for filenum, (thisfile, that_exp_type, thislabel, thiscolor, pushout, concscale, calibration, diameter, const) in enumerate(
            [
              ...
              #      50),
               ('230726_TEMPO_SO4_W0.DSC', exp_type, '(A) W0=0', 'red', 0.2, 200, '230202', 'QESR caps',
                    100),
               ('230726_TEMPO_SO4_W2.DSC', exp_type, '(B) W0=2', 'orange', 0.2, 200, '230202', 'QESR caps',
                    90),
               ('230726_TEMPO_SO4_W10.DSC', exp_type, '(C) W0=10', 'black', 0.2, 200, '230202', 'QESR caps',
                    60),
               ('230726_TEMPO_SO4_W25.DSC', exp_type, '(D) W0=25', 'green', 0.2, 200, '230202', 'QESR caps',
                    30), 
